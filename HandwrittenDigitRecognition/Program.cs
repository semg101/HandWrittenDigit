...
namespace HandwrittenDigitRecognition
{
    public class Program
    {
        ...
        {
            public HandwrittenDigitRecognitionNn(IEnumerable<TrainingSample> trainingDataSet, int inputs, int hiddenUnits, int outputs, double learningRate) : base(trainingDataSet, inputs, hiddenUnits, outputs, learningRate) { }
        }
